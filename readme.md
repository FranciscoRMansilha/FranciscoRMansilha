...
|-------------------------------------|-----------------------------------------------------------------------------------------------------------------------|-------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| Specifix                            | Currently I am not allowed to share details about this project, please come back in the future in case this changes           | Ongoing | `3d object segmentation`, `nnUnetv2`, `Reinforcement Learning`   | Not Available... For now!
