...
On my GitHub profile, you’ll find a selection of projects I’ve developed during my bachelor’s degree, both for clients and as personal endeavors. Each project is accompanied by a brief description, along with additional information about the skills I learned with them. Due to data privacy regulations, I’m unable to share all my projects publicly, so be sure to check the next section for further details. 😁
...
| Project Name/Client                 | Description                                                                                                           | Starting Date and Status            | Skills I Learned                                                                                     | Access                                                   |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------------------|-------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| Specifix                            | Currently I am not allowed to share details about this project, please come back in the future in case this changes           | Ongoing | I am not allowed to share as they might indicate the nature of the project   | Not Available... For now!
| NPEC 🍃 | This project is divided into two phases. The first phase, open to all students, involved building a pipeline that processes images of Arabidopsis Thaliana seedlings in petri dishes, segmenting the plant’s organs, measuring roots, and performing landmark detection. This CV pipeline is also integrated with a robotics system, inoculating plants using a PID controller or Reinforcement Learning algorithm in a simulated OpenTrons-2 machine in PyBullet. The second phase is exclusive to the five students with the best solutions, including myself. We are working closely with NPEC to refine the existing solution, deploy it on their premises, as well as adding new features to the pipeline.| November 2023 - Ongoing  | `Deep Learning`, `U-Net`, `Semantic Segmentation`, `Traditional CV`, `OpenCV`, `Reinforcement Learning`, `OpenAI gym`    | Soon I will be able to share details about both phases!                              |
| PyTorch Tabular                     | I plan to create a series of notebook tutorials on how to use PyTorch Tabular tp solve Tabular Data tasks like classification and regression.    | Ongoing       | `PyTorch`, `Pytorch Tabular`, `Deep Learning`        | Coming soon 👀       |
| Banijay Benelux  📺 | Me and 4 teammates developed a content classification pipeline that identifies show episodes and specific time-stamped fragments based on fragment names, converts them to audio, transcribes and translates them with Whisper, and uses a fine-tuned RoBERTa model to classify emotions. This enables Banijay to match emotional responses in specific segments to viewer ratings.  | February 2023 - Completed         | `Natural Language Processing`, `Transformers`, `Whisper`, `Speech-to-Text`,             | Coming soon 👀                                            |
| AI at BUas 🎓  | We evaluated AI's influence in BUas programs by formulating a research question, hypothesis, and conducting a survey. I was assigned to focus on the Master's in Game Technology and authored a paper on the benefits of integrating Generative AI for academic writing in game development research.   | September 2023 - Finished           | `Research`, `R`, `Statistics`, `Hypothesis Testing`, `Generative AI`             | BUas Internal Use Only                                              |
| Municipality of Breda  | Me and four colleagues created a Streamlit app in which the municipality can monitor relevant data about the city such as nuisance complaints by neighbourhood and others... We also developed a time-series forecasting to help them predict the months in which more nuisances might occur. Lastly we also provided a summary of the insights we found   | May 2023 - Completed | `Time-Series Forecasting`, `SARIMA` `Data Analysis`,`Geodata Visulalization`, `Streamlit`, `Folium`, `statsmodels`, `GeoPandas`              | Due to data privacy concerns I am not able to share code or data about this project                                       |
| Deep Learning-based Image Classifier App| The project was my introduction to deep learning. Our goal was to design a transparent and interpretable image classifier. I prototyped an app called "LuxTriagix," meant for large hospitals to automatically classify patients as children or adults based on a photo, and directing them accordingly either to the pediatric or other facilities. This proof-of-concept was primarily aimed at learning about deep learning. | February 2023 - Finished for now| `Deep Learning`, `Image Classification`, `TensorFlow`, `Transfer Learning`, `Web Scraping`, `Gradcam`, `LIME`, `Explainable AI`,   `Python`                                  | The project is not complete but you can find a big part of it in this [Repository](https://github.com/FranciscoRMansilha/LuzTriagix) |
...
| Sustainable Development Goals 🐟 | Based on UN’s **14th** Sustainable Development Goal (Life below Water) I attempted to answer the problem statements "What is the **current state** of overfishing in the world and how can it be **reduced**?", I collected relevant data and created a Power BI dashboard in which I attempt to answer these questions        | September 2022 - Completed         | `Power BI`, `Data Analysis`, `Data Visualization`,  `Data Storytelling`                                                     | Available at this [Repository](https://github.com/FranciscoRMansilha/SDG-14_Power_BI_Dashboard) |
...
| Containerize Applications with Docker      | `Docker` `Deployment` `Containerization`           | 8          | [Linkedin Learning Certificate 8](https://www.linkedin.com/in/francisco-mansilha/details/certifications/1714386424972/single-media-viewer/?profileId=ACoAADnRD5ABtiF2rRvI7PBOhiYjS8IIfYTQcQk) |
