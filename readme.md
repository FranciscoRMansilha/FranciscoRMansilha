...
| PyTorch Tabular                     | I plan to create a series of notebook tutorials on how to use PyTorch Tabular to solve Tabular Data tasks like classification and regression.    | Ongoing       | `PyTorch`, `Pytorch Tabular`, `Deep Learning`        | The first tutorial is already available! Make sure to check it [here](https://github.com/FranciscoRMansilha/PyTorch-Tabular-Tutorials)  |
